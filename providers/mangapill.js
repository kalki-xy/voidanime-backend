// Placeholder provider — replace with the real MangaPill scraper when available.
// Real file drops in with no server changes needed.
const ERR = 'MangaPill provider not available yet — replace this placeholder with the real provider file.';
